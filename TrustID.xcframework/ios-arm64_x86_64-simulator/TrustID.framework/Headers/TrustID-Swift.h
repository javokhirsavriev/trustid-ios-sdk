...
#ifndef TRUSTID_SWIFT_H
#define TRUSTID_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="TrustID",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7TrustID15AnimatedControl")
...
SWIFT_CLASS("_TtC7TrustID14AnimatedButton")
...
SWIFT_CLASS("_TtC7TrustID14AnimatedSwitch")
...
SWIFT_CLASS("_TtC7TrustID16AnimationSubview")
...
SWIFT_CLASS("_TtC7TrustID19CompatibleAnimation")
...
SWIFT_CLASS("_TtC7TrustID26CompatibleAnimationKeypath")
...
SWIFT_CLASS("_TtC7TrustID23CompatibleAnimationView")
...
SWIFT_CLASS("_TtC7TrustID32CompatibleDictionaryTextProvider")
...
///   </li>
/// </ul>
SWIFT_CLASS("_TtC7TrustID20LottieAnimationLayer")
...
SWIFT_CLASS("_TtC7TrustID23LottieAnimationViewBase")
...
/// </ul>
IB_DESIGNABLE
SWIFT_CLASS("_TtC7TrustID19LottieAnimationView")
...
SWIFT_CLASS("_TtC7TrustID14PassportReader") SWIFT_AVAILABILITY(ios,introduced=13)
...
SWIFT_CLASS("_TtC7TrustID15SessionDelegate")
...
@interface SessionDelegate (SWIFT_EXTENSION(TrustID)) <NSURLSessionDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(TrustID)) <NSURLSessionDataDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(TrustID)) <NSURLSessionDownloadDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(TrustID)) <NSURLSessionTaskDelegate>
...
SWIFT_CLASS("_TtC7TrustID13TrustIdAction")
@interface TrustIdAction : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class TrustIdResult;

SWIFT_CLASS("_TtCC7TrustID13TrustIdAction8Complete")
@interface Complete : TrustIdAction
@property (nonatomic, strong) TrustIdResult * _Nonnull result;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class TrustIdException;

SWIFT_CLASS("_TtCC7TrustID13TrustIdAction5Error")
@interface Error : TrustIdAction
@property (nonatomic, strong) TrustIdException * _Nonnull exception;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtCC7TrustID13TrustIdAction10Permission")
@interface Permission : TrustIdAction
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtCC7TrustID13TrustIdAction7Timeout")
@interface Timeout : TrustIdAction
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtCC7TrustID13TrustIdAction6Cancel")
@interface Cancel : TrustIdAction
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class UIImage;

SWIFT_CLASS("_TtC7TrustID17TrustIdAppearance")
@interface TrustIdAppearance : NSObject
...
@class TrustIdConfig;
@protocol TrustIdClientDelegate;

SWIFT_CLASS("_TtC7TrustID13TrustIdClient")
@interface TrustIdClient : NSObject
+ (void)showScannerWithConfig:(TrustIdConfig * _Nonnull)config withDelegate:(id <TrustIdClientDelegate> _Nonnull)delegate;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_PROTOCOL("_TtP7TrustID21TrustIdClientDelegate_")
@protocol TrustIdClientDelegate
- (void)onCompletionWithAction:(TrustIdAction * _Nonnull)action;
@end

enum TrustIdEnvironment : NSInteger;
enum TrustIdDocumentType : NSInteger;
enum TrustIdLocale : NSInteger;
enum TrustIdPresentationStyle : NSInteger;

SWIFT_CLASS("_TtC7TrustID13TrustIdConfig")
@interface TrustIdConfig : NSObject
@property (nonatomic, copy) NSString * _Nonnull apiKey;
@property (nonatomic, strong) UIImage * _Nullable faceImage;
@property (nonatomic) enum TrustIdEnvironment environment;
@property (nonatomic) enum TrustIdDocumentType documentType;
...
@property (nonatomic) enum TrustIdLocale locale;
@property (nonatomic) enum TrustIdPresentationStyle presentationStyle;
@property (nonatomic, strong) TrustIdAppearance * _Nullable appearance;
@property (nonatomic) BOOL withApi;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC7TrustID19TrustIdDocumentData")
@interface TrustIdDocumentData : NSObject
...
@property (nonatomic, copy) NSString * _Nonnull issuedBy;
@property (nonatomic, copy) NSString * _Nonnull issuedDate;
@property (nonatomic, copy) NSString * _Nonnull expiryDate;
@property (nonatomic, copy) NSString * _Nonnull birthPlace;
@property (nonatomic, copy) NSString * _Nonnull birthDate;
@property (nonatomic, copy) NSString * _Nonnull mrz;
@property (nonatomic, copy) NSString * _Nonnull mrzKey;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

typedef SWIFT_ENUM(NSInteger, TrustIdDocumentType, open) {
  TrustIdDocumentTypeIdCard = 0,
  TrustIdDocumentTypePassport = 1,
  TrustIdDocumentTypeManual = 2,
};

typedef SWIFT_ENUM(NSInteger, TrustIdEnvironment, open) {
  TrustIdEnvironmentProduction = 0,
  TrustIdEnvironmentDevelopment = 1,
};


SWIFT_CLASS("_TtC7TrustID16TrustIdException")
@interface TrustIdException : NSObject
@property (nonatomic, copy) NSString * _Nullable message;
@property (nonatomic) NSInteger code;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

typedef SWIFT_ENUM(NSInteger, TrustIdLocale, open) {
  TrustIdLocaleUzbek = 0,
  TrustIdLocaleEnglish = 1,
  TrustIdLocaleRussian = 2,
};

typedef SWIFT_ENUM(NSInteger, TrustIdPresentationStyle, open) {
  TrustIdPresentationStyleFull = 0,
  TrustIdPresentationStyleSheet = 1,
};


SWIFT_CLASS("_TtC7TrustID13TrustIdResult")
@interface TrustIdResult : NSObject
@property (nonatomic, strong) TrustIdDocumentData * _Nonnull documentData;
@property (nonatomic, strong) UIImage * _Nullable documentFaceImage;
@property (nonatomic, strong) UIImage * _Nullable documentFrontImage;
@property (nonatomic, strong) UIImage * _Nullable documentBackImage;
